                            ...
                            <div class="card  mb-4">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-lg mb-0 text-capitalize font-weight-bold">어제의 매출액</p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="state3" countTo="${yesterdayTotal}"></span><span
                                                        class="small">원</span>
                            ...
                            <div class="card ">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-lg mb-0 text-capitalize font-weight-bold">어제 다녀간 고객</p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="state4" countTo="${yesterdayCTotal}"></span><span
                                                        class="small">명</span>
                                                    <span class="text-success text-sm font-weight-bolder">+3%  </span>
                                                </h5>
                                            </div>
                            ...
                            <div class="card  mb-4">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-lg mb-0 text-capitalize font-weight-bold">오늘의 매출액</p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="state5" countTo="${todayTotal}"></span><span
                                                        class="small">원</span>
                                                </h5>
                                            </div>
                                        </div>
                            ...
                            <div class="card ">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-lg mb-0 text-capitalize font-weight-bold">오늘 방문할 고객</p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="state6" countTo="${todayCTotal}"></span><span
                                                        class="small">명</span>
                                                </h5>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    <td class="w-30">
                                                        <div class="d-flex px-2 py-1 align-items-center">
                                                            ...
                                                            <div class="ms-4">
                                                                <p class="text-m font-weight-bold mb-0">순위</p>
                                                                <h6 class="text-m mb-0">${obj.rank}</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-sm">
                                                        <div class="col text-center">
                                                            <p class="text-m font-weight-bold mb-0">이름</p>
                                                            <h6 class="text-m mb-0">${obj.trainerName}</h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-center">
                                                            <p class="text-m font-weight-bold mb-0">이번달 예약건수</p>
                                                            <h6 class="text-m mb-0">${obj.count_this_month}</h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-center">
                                                            <p class="text-m font-weight-bold mb-0">지난달 수업건수</p>
                                                            <h6 class="text-m mb-0">${obj.count_last_month}</h6>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0" style="font-size: 20px;">18:00</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="font-weight-bold" style="font-size: 18px;"> 45% </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0" style="font-size: 20px;">19:00</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="font-weight-bold" style="font-size: 18px;"> 20% </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0" style="font-size: 20px;"> 21:00 </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0" style="font-size: 20px;"> 20:30 </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="font-weight-bold" style="font-size: 18px;"> 8% </span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
