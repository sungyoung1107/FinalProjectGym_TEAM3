                            ...
                            <div class="col-lg-4 mb-lg-0 mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-lg-start text-center pt-0">
                                        ...
                                        <a href="/gym/register" class="btn btn-icon bg-gradient-primary d-lg-block mt-3 mb-0">
                                            가입하기
                                            ...
                                            <div class="col-8">
                                                <div class="numbers">
                                                    ...
                                                    <h5 class="font-weight-bolder mb-0">
                                                        <span id="state3" countTo="1254000"></span><span class="small">원</span>
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="numbers">
                                                    ...
                                                    <h5 class="font-weight-bolder mb-0">
                                                        <span id="state4" countTo="74"></span><span class="small">명</span>
                                                        <span class="text-success text-sm font-weight-bolder">+3%  </span>
                                                    </h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="numbers">
                                                    ...
                                                    <h5 class="font-weight-bolder mb-0">
                                                        <span id="state5" countTo="554000"></span><span class="small">원</span>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="col-4 text-end">
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="numbers">
                                                    ...
                                                    <h5 class="font-weight-bolder mb-0">
                                                        <span id="state6" countTo="54"></span><span class="small">명</span>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="col-4 text-end">
                ...
                <div class="row">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-7 col-md-12 z-index-2">
                            <div class="card">
                                <div class="card-header pb-0 p-3">
                                    <h6 class="mb-0">센터 매출 추이  전체 센터 매출 / 내 센터 비교</h6>
