    ...
    <div class="sidenav-header">
        ...
        <c:choose>
            <c:when test="${loginadmin != null}">
                <a href="/">
                    <img src="/assets/img/adminlogo.png" style="margin-left: 30px; margin-top: 15px; width: 180px;">
                </a>
            </c:when>
            <c:otherwise>
                <a href="/">
        ...
        <c:otherwise>
            <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link active"
                           ...
                           aria-expanded="false">
                            ...
                            <span class="nav-link-text ms-1">센터 가입승인</span>
                        </a>
                    ...
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#pagesExamples2" class="nav-link "
                           aria-controls="pagesExamples"
                           role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            ...
                            <span class="nav-link-text ms-1">쿠폰발행</span>
                        </a>
                            ...
                            <ul class="nav ms-4 ps-3">
                                <li class="nav-item">
                                    <a class="nav-link " aria-expanded="false"
                                       href="/coupon/add">
                                        <span class="sidenav-mini-icon"> C </span>
                                        <span class="sidenav-normal"> 쿠폰등록 <b class="caret"></b></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " aria-expanded="false"
                                       href="/coupon/all">
                                        <span class="sidenav-mini-icon"> T </span>
                                        <span class="sidenav-normal"> 쿠폰리스트 <b class="caret"></b></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <ul class="navbar-nav  justify-content-end">
                            <li class="nav-item d-flex align-items-center">
                                <a href="/" class="nav-link text-body font-weight-bold px-0">
                                    ...
                                    <span class="d-sm-inline d-none">${logingym != null ? logingym.gymName : loginadmin.adminId}</span>
                                </a>
                            </li> &nbsp;&nbsp;
                            <li class="nav-item d-flex align-items-center">
