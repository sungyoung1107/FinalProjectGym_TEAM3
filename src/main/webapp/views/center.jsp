        ...
        <div class="col-xl-8 col-lg-7">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card overflow-hidden">
                        <div class="card-header p-3 pb-0">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">오늘 다녀간 고객</p>
                            <h5 class="font-weight-bolder mb-0">
                                5,927
                                <span class="text-success text-sm font-weight-bolder">전일대비 +55%</span>
                            </h5>
                        </div>
                ...
                <div class="col-sm-4 mt-sm-0 mt-4">
                    <div class="card overflow-hidden">
                        <div class="card-header p-3 pb-0">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">오늘의 이용권 매출액</p>
                            <h5 class="font-weight-bolder mb-0">
                                $130,832
                                <span class="text-success text-sm font-weight-bolder">전일대비 90%</span>
                            </h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="chart">
                    ...
                    <div class="card p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                            ...
                            <div class="card-body position-relative z-index-1 h-100 p-3">
                                ...
                                <p class="text-white mb-3">Wealth creation is an evolutionarily recent positive-sum
