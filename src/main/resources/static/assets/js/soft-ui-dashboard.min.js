...
var soft = {
    initFullCalendar  : function () {
        ...
        if ("basic" == e) Swal.fire('기본입니다'); else if ("email_default" == e) Swal.fire('Email을 입력해주세요');
        else if ("email_format" == e) Swal.fire('Email 형식이 아닙니다');
        else if ("reginum_default" == e) Swal.fire('사업자번호를 입력해주세요');
        else if ("reginum_format" == e) Swal.fire('사업자번호 형식이 아닙니다');
